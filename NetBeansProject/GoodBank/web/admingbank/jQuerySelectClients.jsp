...
<c:if test="${empty param.edit}">
	...
	${row.client_id},${row.id_card},${row.name},${row.lastname_first},${row.lastname_second},${row.birth_date},${row.street_type},${row.address},${row.province},${row.community},${row.phone_number},${row.client_range}#
    </c:forEach>
</c:if>
